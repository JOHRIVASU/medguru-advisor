...
lottie_coding = load_lottiefile(r"C:\Users\VASU\OneDrive\Desktop\medguru\vasu2.json")
...
# Set OpenAI API key
api_key = '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'
...
def generate_response(prompt_text):
    response = openai.Completion.create(
        engine="text-ada-001",  # You can choose a different engine if needed
        prompt=prompt_text,
...
def show_developers():
    ...
    developers = [
        ...
        {
            "name": "Vasu Johri",
            "bio": "Experienced in frontend development with expertise in HTML, CSS, and JavaScript and chatbot.",
        ...
        {
            "name": "Sangameshwar Narayanan",
            "bio": "Experienced in ML development with expertise in HuggingFace",
            "linkedin": "https://www.linkedin.com/in/sangam-narayanan-322b75239/",
            "profile_photo": "https://media.licdn.com/dms/image/D4D03AQHu6WEHdMwV9g/profile-displayphoto-shrink_400_400/0/1703261299063?e=1710374400&v=beta&t=SSflDiESywUIH9ujsrRKeP1eqkfeij-DtJXfKO4QlGw",  # Insert the URL for the profile photo
        },
